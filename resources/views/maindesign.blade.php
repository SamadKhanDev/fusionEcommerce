      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-3">
            ...
            <p>
             At Sam Fusion, we bring you the latest and most reliable electronic products. Quality, innovation, and customer satisfaction are our top priorities—making technology easy and enjoyable for everyone.
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="info_form ">
              <h5>
          ...
          <div class="col-md-6 col-lg-3">
            ...
            <p>
             We’re here for you! Whether you have questions about our products, orders, or returns, our support team is ready to assist.
            </p>
          </div>
          <div class="col-md-6 col-lg-3">
            <h6>
            ...
            <div class="info_link-box">
              <a href="">
                ...
                <span>Shara-e-Faisal, Karachi,Pakistan</span>
              </a>
              <a href="">
                <i class="fa fa-phone" aria-hidden="true"></i>
                <span>+92 330912892</span>
              </a>
              <a href="">
                <i class="fa fa-envelope" aria-hidden="true"></i>
                <span> support@samfusion.com</span>
              </a>
            </div>
          </div>
        </div>
